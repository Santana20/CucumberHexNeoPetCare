...
Feature: Registro de Vacunas a mis mascotas
  ...
  Scenario: Regsitro exitoso
    ...
    And me ubico en la ruta "/vacunamascota/registrarVacunaMascota/" para registrar vacuna a mascota
    And teniendo como codigo de mi mascota "1" para registrar vacuna a mascota
